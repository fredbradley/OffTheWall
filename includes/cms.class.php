    ...
    <td valign="top">
      ...
      <table width="650" border="0" align="center" cellpadding="10" cellspacing="0" bgcolor="#ffffff">
        <tr>
          <td valign="top">
            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="67" width="350"  align="left" valign="middle" bgcolor="#FFFFFF" style="color: #e3e3e3; font-family: Helvetica, sans-serif; font-size: 12px; letter-spacing: 0px;"><h1>Please Verify your Talent Cow Account</h1></td>
                </tr>
              <tr>
                <td height="19" colspan="2" align="left" bgcolor="#FFFFFF" style="font-family: Arial, Helvetica, sans-serif; color: #7a7a7a; font-size: 12px; letter-spacing: -1px;"><img src="http://www.talentcow.com/img/full_width_hr.jpg" width="633" height="20" alt="break1" /></td>
              </tr>
              <tr>
		...
		<table width="633" border="0" cellspacing="0" cellpadding="0">
  			...
  			<tr>
    <td width="210" align="left" valign="top"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #7a7a7a; line-height: 18px;"><img src="http://www.talentcow.com/img/milk.png" width="200" height="500" alt="pic1" /></span></td>
    <td width="423" align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #7a7a7a; line-height: 18px;"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #33333c; line-height: 18px;">Subject: Please Verify your Account</span>
...
<span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #373737; line-height: 18px;">the web dude - talentcow limited</span>
            ...
            <table width="633" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="401" align="left" valign="top" style="font-family: Helvetica, sans-serif; font-size: 11px; color: #7a7a7a; line-height: 16px;"><p>Copyright &copy; 2012 talentcow limited. All Rights Reserved.<br />
